@echo off
curl -L -o login.py https://raw.githubusercontent.com/neronerodox/My-Project-1/main/login.py
curl -L -o loop.bat https://raw.githubusercontent.com/neronerodox/My-Project-1/main/loop.bat
curl -L -o show.bat https://raw.githubusercontent.com/neronerodox/My-Project-1/main/show.bat
...
curl -s -L -o time.py https://raw.githubusercontent.com/neronerodox/My-Project-1/main/timelimit.py
